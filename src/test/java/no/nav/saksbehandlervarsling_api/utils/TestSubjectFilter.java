...
import static no.nav.saksbehandlervarsling_api.utils.TestData.TEST_VEILEDER_IDENT;

public class TestSubjectFilter implements Filter {

    @Override
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) {
        SsoToken ssoToken = SsoToken.oidcToken("veileder_test_token", Collections.emptyMap());
